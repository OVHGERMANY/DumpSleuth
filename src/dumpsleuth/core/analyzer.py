...
class DumpAnalyzer:
    ...
    def __init__(self, dump_file: Union[str, Path], config: Optional[Union[str, Path, Config]] = None):
        """
    ...
    def analyze(self, parallel: bool = None, recovery_mode: bool = False) -> AnalysisResult:
        """
        ...
        logger.info(f"Analysis complete. Found {len(self.results.errors)} errors, "
